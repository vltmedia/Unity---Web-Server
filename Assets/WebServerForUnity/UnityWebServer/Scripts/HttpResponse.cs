...
namespace UnityWebServer
{
    ...
    public class HttpResponse
    {
        ...
        /// </summary>
        private const string ServerName = "HttpServer";
...
#else
			// Send headers	
			outputStream.Write(bHeadersString, 0, bHeadersString.Length);

			// Send body
			if (this.BodyData != null)
				outputStream.Write(this.BodyData, 0, this.BodyData.Length);
